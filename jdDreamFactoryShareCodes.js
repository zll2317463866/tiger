...
let shareCodes = [
    'lSWf-67KPLhcoCafOyBa5A==@',//账号一的好友shareCode,不同好友中间用@符号隔开
    'lSWf-67KPLhcoCafOyBa5A==',//账号二的好友shareCode，不同好友中间用@符号隔开
]
...
if (process.env.DREAM_FACTORY_SHARE_CODES) {
    ...
    console.log(`去设置变量(DREAM_FACTORY_SHARE_CODES)不同好友中间用@符号隔开`)
}

...
[task_local]
#京东宠汪汪喂食
* /1 * * * jd_joy_feedPets.js, tag=京东宠汪汪喂食, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon===============
[Script]
cron "*/1 * * *" script-path=jd_joy_feedPets.js,tag=京东宠汪汪喂食

=========Surge=============
[Script]
京东宠汪汪喂食 = type=cron,cronexp="*/1 * * *",wake-system=1,timeout=3600,script-path=jd_joy_feedPets.js

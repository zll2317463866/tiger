...
[task_local]
#城城领现金
0 0-23/5,22 * 10 * gua_city.js, tag=城城领现金
...
let inviteCodes = ['29DRE8UEEltUaSu3auhtM7m0OOXzy025']
$.shareCodesArr = [];
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            for (let i = 0; i < $.newShareCodes.length && true; ++i) {
                ...
                let ress = await getInviteId($.newShareCodes[i])
                console.log(ress)
...
function taskPostUrl(functionId,body) {
    return {
        url: `${JD_API_HOST}`,
        body: `functionId=${functionId}&appid=signed_wh5&body=${escape(JSON.stringify(body))}&client=apple&clientVersion=11.3.2&uuid=193010818728972.1.1672283386335&osVersion=&screen=400*700&networkType=&timestamp=1672283390879&d_brand=&d_model=&partner=&build=&openudid=&h5st=20221229110950915%3B4488795961249704%3B9314b%3Btk02w73dc1b5118n7GtVA1UL1ZT1Lrn5N3Zjr5FXCROnKbLrqPxjXN%2BSPTl%2Bb15Og5umOg%2FJByoKngJg4Fk5tlDHkfRD%3B713296fc1a0ba469d081677b6689b8d8f9212359901fae341f9bd9847d147b0f%3B3.1%3B1672283390915%3B95229b075e3b86bcee5f2b7186a7882cd8da35131a60e7143d3afff3c5985a4929281ca92ccb928111a7c57e9b3200ed3582f8241ed78dc22c9cc0a0b95963a7a3445852b192cb04c7bf24935797a2da41818123a59d2585938b37f2a71190cd`,
        headers: {
'Host': 'api.m.jd.com',
'cookie':cookie,
...
function getInviteId(inviteId) {
    let body ={"lbsCity":"","realLbsCity":"","inviteId":inviteId,"headImg":"","userName":"","taskChannel":"1","location":"","safeStr":"{\"log\":\"1672283390854~1y5vxQCl89o75ab23a7b84992b2e7a3f01bad4e851f~3%2C1~559585AABDED309E7B3DE66236DAE693C5191D8C~0fngv09~C~~019fchz\",\"sceneid\":\"CHFhPageh5\",\"random\":\"20568797\"}"}
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.code === 0) {
                            if (data.data && data['data']['bizCode'] === 0) {
                                ...
                                //console.log(data.data.result.mainInfos)

...
let inviteCodes = [['RtGKzrnwSA-ie9WfRYIx1Otl4csOqCiZKzPrVdHxcs8WT3DayA@RtGKzOmgFVv2f4vLQdZm0Uk2R0l26YZamstk_1z3KG7EPOEfZg@RtGKkrLzK2vZIv3SRJBHmv7V-ZhDXrgN_2P8zMGrcgaXs4Yq@RtGKzeWjEA-neoSSQ9Q11Ri8SFAKZSxBPIX62j83L7BlyYfN8A'].sort(() => 0.5 - Math.random()).join('@')]
!(async () => {
  if (!cookiesArr[0]) {
    $.msg($.name, '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/bean/signIndex.action', {"open-url": "https://bean.m.jd.com/bean/signIndex.action@RtGKkrLzK2vZIv3SRJBHmv7V-ZhDXrgN_2P8zMGrcgaXs4Yq"});
    return;
  }
  await requireConfig();
  if (exchangeFlag) {

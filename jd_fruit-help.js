...
const $ = new Env('东东农场-内部互助');
let cookiesArr = [], cookie = '', jdFruitShareArr = [], isBox = false, notify, newShareCodes, allMessage = '';
//助力好友分享码(最多3个,否则后面的助力失败),原因:京东农场每人每天只有3次助力机会
//此此内容是IOS用户下载脚本到本地使用，填写互助码的地方，同一京东账号的好友互助码请使用@符号隔开。
//下面给出两个账号的填写示例（iOS只支持2个京东账号）
let shareCodes = []
let inviteCodes = [ //账号一的好友shareCode,不同好友的shareCode中间用@符号隔开
 '61ccfd34e8a9477a9daf414ab3ec743b@65b1b666599043dc81404a968cd6d6c7@f2d697353b404ff1b4e954eb75df046c@6fbd26cc27ac44d6a7fed34092453f77',
...
!(async () => {
  ...
  console.log(`格式化后的助力码::${JSON.stringify(shareCodes)}\n`);
...
async function jdFruit() {
  ...
  try {
    ...
    if ($.farmInfo.farmUserPro) {
      ...
      shareCodes.push($.farmInfo.farmUserPro.shareCode)
      console.log(`收集邀请码‼️`)
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    //console.log(`您提供了${inviteCodes.length}个账号的农场助力码\n`);
    resolve()
  })
}
function TotalBean() {

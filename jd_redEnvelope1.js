...
================Loon==============
[Script]
cron "0 0,12,20,21 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope.js,tag=京东领红包

===============Surge=================
京东领红包 = type=cron,cronexp="0 0,12,20,21 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope.js

============小火箭=========
京东领红包 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_redEnvelope.js, cronexpr="0 0,12,20,21 * * *", timeout=3600, enable=true

*/

const $ = new Env('京东领红包');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let flCode = ["Sdu19Mo","SwfDVb6"]
flCode = flCode[Math.floor((Math.random() * flCode.length))]
if ($.isNode() && process.env.FLCODE3) {
  // flClode = process.env.FLCODE3
}
let cookiesArr = [];
if ($.isNode()) {
